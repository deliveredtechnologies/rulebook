...
[![License](https://img.shields.io/badge/license-Apache%202.0-blue.svg)][Apache 2.0 License] [![Maven Central](https://img.shields.io/badge/maven%20central-0.11-brightgreen.svg)][RuleBook-Core Maven Central] [![Build Status](https://travis-ci.org/deliveredtechnologies/rulebook.svg?branch=develop&maxAge=600)](https://travis-ci.org/deliveredtechnologies/rulebook) [![Coverage Status](https://coveralls.io/repos/github/deliveredtechnologies/rulebook/badge.svg?branch=develop&maxAge=600)](https://coveralls.io/github/deliveredtechnologies/rulebook?branch=develop)  [![Gitter](https://badges.gitter.im/RuleBook.svg)](https://gitter.im/RuleBook?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge) [![Paypal](https://img.shields.io/badge/donate-PayPal-blue.svg)](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=C6EM6HRN45L72)
